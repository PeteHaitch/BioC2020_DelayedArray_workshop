...
- Docker image: [Docker Hub](https://hub.docker.com/repository/docker/petehaitch/bioc2020_delayedarray_workshop)
- Workshop material: [pkgdown website](https://petehaitch.github.io/BioC2020_DelayedArray_workshop)
...
Please see the workshop [`DESCRIPTION`](https://github.com/PeteHaitch/BioC2020_DelayedArray_workshop/blob/master/DESCRIPTION) for a full list of dependencies.
