...
vignette: >
  %\VignetteIndexEntry{500: Effectively using the DelayedArray framework as a package developer to support the analysis of large datasets}
...
Although each _assay_ is here drawn as a matrix, higher-dimensional arrays are also supported.
`r knitr::include_graphics(file.path(system.file(package = 'DelayedArrayWorkshop', 'vignettes'), "SummarizedExperiment.png"))`
