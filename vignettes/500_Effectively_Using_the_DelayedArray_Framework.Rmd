...
vignette: >
  %\VignetteIndexEntry{500: Effectively using the DelayedArray framework to support the analysis of large datasets}
...
**TODO:** Re-use existing SE figure.

![The _SummarizedExperiment_ class is used to store rectangular arrays of experimental results (_assays_). Although each _assay_ is here drawn as a matrix, higher-dimensional arrays are also supported.](../vignettes/SummarizedExperiment.png)
...
#       encoded data.
da_Rle <- RleArray(Rle(mat), dim = dim(mat))
da_Rle
```
...
hdf5_file <- system.file(
  "extdata", "hdf5_mat.h5", 
  package = "DelayedArrayWorkshop")
...
![](../vignettes/Slide1.png)

![](../vignettes/Slide2.png)

![](../vignettes/Slide3.png)

![](../vignettes/Slide4.png)

![](../vignettes/Slide5.png)

![](../vignettes/Slide6.png)

![](../vignettes/Slide7.png)
