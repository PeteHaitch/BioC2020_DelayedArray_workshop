...
This was needed in order to store and analyse large non-CpG methylation data sets  (> 300 million loci, hundreds of samples) using HDF5 files.
...
This is needed in order to store and analyse large methylation data sets (> 850,000 loci, tens of thousands of) using HDF5 files.
