...
# TODO: Convert assay data to TENxMatrix object?
```
...
table(clusters)
# TODO: Step through quickCluster with the HDF5-backed data to figure out why 
#       it's so slow.
```
...
This is a near instantaneous because it is a delayed operation operating on the counts matrix!
...
We'll use the `scran::makeTechTrend()` function to model the technical variation of the counts matrix as Poisson noise.
**TODO:** Describe DA operations of this method.
...
To finish this example analysis, we'll create the *de rigueur* $t$-SNE plot.
The first step is to perform a PCA of the log-expression matrix.
This denoises the log-expression data by removing principal components corresponding to technical noise
...
pcs <- denoisePCA(
  ...
  # TODO: How long did this take to do 'properly' on my laptop?
