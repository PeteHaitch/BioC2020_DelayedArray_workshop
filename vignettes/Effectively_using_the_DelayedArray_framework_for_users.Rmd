...
output:
  rmarkdown::html_document:
   ...
   fig_width: 5
vignette: >
  %\VignetteIndexEntry{Effectively using the DelayedArray framework to support the analysis of large datasets}
...
We'll illustrate chunking with the HDF5 format, but similar concepts exist for other disk-backed data (e.g., *TileDBArray*, `r BiocStyle::Biocpkg("matter")`) and even to in-memory data (e.g., *RleArray*).
