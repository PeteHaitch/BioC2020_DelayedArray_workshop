...
output:
  rmarkdown::html_document:
   ...
   fig_width: 5
vignette: >
  %\VignetteIndexEntry{BioC 2020 DelayedArray workshop}
...
The process of realization used block processing, which avoids loading the entire dataset entire memory.
