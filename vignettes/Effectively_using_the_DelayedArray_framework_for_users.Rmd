...
```{r, message = FALSE}
# NOTE: The TENxBrainData package loads and attaches the DelayedArray package, 
#       amongst others.
...
- [x] Re-use existing SE figure (https://github.com/Bioconductor/SummarizedExperiment/blob/1c9719593f1a5fcb3ebe1c8cff2029c6039445e0/vignettes/SummarizedExperiment.Rmd#L71-L78)
- [x] Remove old SE figure from package.
